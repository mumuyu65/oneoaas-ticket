...
var HandlingTicket={
    ...
    Table:function () {
        var $table = $('#handling_ticket_result');
        var tableOptions={
            data: [],
        ...
        $.ajax({
            ...
            method:'POST',
            dataType: 'json',
            data:HandlingTicket.params,
            beforeSend: function () {
                $('#handling_ticket_result').append('<div class="loader"><div class="loader-inner ball-pulse"><div></div><div></div><div></div></div></div>');
            },
            success:function (d) {
                console.log(d);
