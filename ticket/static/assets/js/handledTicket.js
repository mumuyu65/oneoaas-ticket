...
var HandledTicket={
    ...
    Table:function () {
        var $table = $('#handled_ticket_result');
        var tableOptions={
            data: [],
        ...
        $.ajax({
            ...
            method:'POST',
            dataType: 'json',
            data:HandledTicket.params,
            beforeSend: function () {
                $('#handled_ticket_result').append('<div class="loader"><div class="loader-inner ball-pulse"><div></div><div></div><div></div></div></div>');
            },
            success:function (d) {
                console.log(d);
